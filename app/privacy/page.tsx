...
const Privacy = () => {
  return (
    <section className="prose prose-slate prose-invert m-auto mt-20 max-w-6xl px-6 pb-6 text-slate-200 lg:prose-xl prose-a:no-underline prose-a:transition hover:prose-a:text-indigo-400 prose-pre:bg-slate-200 prose-pre:text-slate-800 md:pb-12">
      <h1 className="text-3xl font-bold text-slate-200">Privacy Policy</h1>
      <p className="text-slate-400">Last updated: February 18, 2024</p>
      ...
      <h3 className="text-lg font-bold text-slate-200">Interpretation</h3>
      <p className="text-slate-400">
      ...
      <h3 className="text-lg font-bold text-slate-200">Definitions</h3>
      <p className="text-slate-400">For the purposes of this Privacy Policy:</p>
      <ul>
        <li>
          <p className="text-slate-400">
        ...
        <li>
          <p className="text-slate-400">
            ...
            <a
              className="font-semibold text-slate-200 hover:text-indigo-400"
              href="http://www.the-still-river.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://www.the-still-river.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p className="text-slate-400">First name and last name</p>
        </li>
        <li>
          <p className="text-slate-400">Usage Data</p>
        </li>
      </ul>
      <h4>Usage Data</h4>
      <p className="text-slate-400">
      ...
      <ul>
        <li>
          ...
          <p className="text-slate-400">Type: Session Cookies</p>
          <p className="text-slate-400">Administered by: Us</p>
          <p className="text-slate-400">
        ...
        <li>
          ...
          <p className="text-slate-400">Type: Persistent Cookies</p>
          <p className="text-slate-400">Administered by: Us</p>
          <p className="text-slate-400">
      ...
      <ul>
        <li>
          <p className="text-slate-400">
            By email: michael@the-still-river.com
          </p>
        </li>
        <li>
          <p className="text-slate-400">
