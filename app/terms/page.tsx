...
const Terms = () => {
  return (
    <section className="prose prose-slate prose-invert m-auto mt-20 max-w-6xl px-6 pb-6 text-slate-200 lg:prose-xl prose-a:no-underline prose-a:transition hover:prose-a:text-indigo-400 prose-pre:bg-slate-200 prose-pre:text-slate-800 md:pb-12">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to The Still River.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to The Still River, accessible from{" "}
            <a
              href="https://www.the-still-river.com"
      ...
      <ul>
        <li>
          <p>By email: michael@the-still-river.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.the-still-river.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.the-still-river.com/contact
            </a>
          </p>
        </li>
      </ul>
