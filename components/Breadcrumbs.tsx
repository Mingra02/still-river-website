...
const Breadcrumbs: React.FC<BreadcrumbsProps> = ({ links }) => {
  return (
    <div className="mx-4 mt-6 inline-flex items-center rounded border border-slate-500 px-2 text-slate-400 md:px-4">
      ...
      {links.map((link, index) => (
        <React.Fragment key={index}>
          ...
          <div className="px-2 py-2 text-center md:px-4">
